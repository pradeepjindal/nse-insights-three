...
public abstract class BaseUploader {
    ...
    protected BaseUploader(PraNameUtils praNameUtils, String fileDirName, String filePrefix) {
    ...
    public void uploadFromLast() {
        ...
        String str = praNameUtils.getLatestFileNameFor(dataDir, filePrefix, ApCo.PRA_DATA_FILE_EXT, 1);
