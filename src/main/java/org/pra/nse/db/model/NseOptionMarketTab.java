...
@Entity
@Table(name = "Nse_Option_Market_Tab")
public class NseOptionMarketTab implements Serializable {
...
//    @SequenceGenerator(name = "auto_gen", sequenceName = "A")
    @SequenceGenerator(name = "nse_option_market_seq_id", sequenceName = "nse_option_market_seq_id", initialValue = 1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "nse_option_market_seq_id")
    private Long id;
