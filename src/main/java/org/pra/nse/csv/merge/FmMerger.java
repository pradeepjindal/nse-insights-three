...
public class FmMerger {
    ...
    public FmMerger(PraFileUtils praFileUtils, FmCsvReader csvReader) {
    ...
    public TreeSet<LocalDate> merge(List<PraBean> praBeans, LocalDate forDate) throws FileNotFoundException {
        ...
        String foLatestFileName = praFileUtils.getLatestFileNameFor(ApCo.FM_FILES_PATH, ApCo.PRA_FM_FILE_PREFIX, ApCo.PRA_DATA_FILE_EXT,1, forDate);
        ...
        String foPreviousFileName = praFileUtils.getLatestFileNameFor(ApCo.FM_FILES_PATH, ApCo.PRA_FM_FILE_PREFIX, ApCo.PRA_DATA_FILE_EXT,2, forDate);
