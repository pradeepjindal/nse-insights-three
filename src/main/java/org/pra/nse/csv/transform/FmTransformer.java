...
public class FmTransformer extends BaseTransformer {
    ...
    private Map<String, String> prepare(LocalDate fromDate) {
        ...
        fileNames.forEach( nseFileName -> {
            ...
            LocalDate localDate = DateUtils.getLocalDateFromPath(nseFileName, ApCo.NSE_FM_FILE_NAME_DATE_REGEX, ApCo.NSE_FM_FILE_NAME_DATE_FORMAT);
            String praFileName = ApCo.PRA_FM_FILE_PREFIX + localDate.toString() + ApCo.PRA_DATA_FILE_EXT;
...
//            try {
//                nseFileUtils.unzipNew(source, ApCo.PRA_FM_FILE_PREFIX);
